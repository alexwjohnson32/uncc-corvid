...
class IEEE13FederatePlugin(interface.IDeployable):
    @classmethod
    def _get_federate_deploy_path(cls) -> pathlib.Path:
        return pathlib.Path("gridpack", "IEEE-13")
    ...
    def _get_baseline_files(self, root: pathlib.Path) -> FederateFiles:
        return FederateFiles(
            PhaseFiles(
                ...
                root / "README.md",
                root / "IEEE13_phase_A.raw",
                root / "input_13_bus_phase_A.xml",
                root / "helics_setup_phase_a.json"
            ),
            PhaseFiles(
                root / "one-phase-gridpack-federate",
                root / "README.md",
                root / "IEEE13_phase_B.raw",
                root / "input_13_bus_phase_B.xml",
                root / "helics_setup_phase_b.json"
            ),
            PhaseFiles(
                root / "one-phase-gridpack-federate",
                root / "README.md",
                root / "IEEE13_phase_C.raw",
                root / "input_13_bus_phase_C.xml",
    ...
    def _get_model_files(self, deploy_root: str, model_name: str) -> FederateFiles:
        ...
        return FederateFiles(
            PhaseFiles(
                ...
                phase_a_path / "IEEE13_phase_A.raw",
                phase_a_path / "input_13_bus_phase_A.xml",
                phase_a_path / "helics_setup_phase_a.json"
            ),
            PhaseFiles(
                phase_b_path / "one-phase-gridpack-federate",
                phase_b_path / "README.md",
                phase_b_path / "IEEE13_phase_B.raw",
                phase_b_path / "input_13_bus_phase_B.xml",
                phase_b_path / "helics_setup_phase_b.json"
            ),
            PhaseFiles(
                phase_c_path / "one-phase-gridpack-federate",
                phase_c_path / "README.md",
                phase_c_path / "IEEE13_phase_C.raw",
                phase_c_path / "input_13_bus_phase_C.xml",
